...
import { logo, menu,close } from '../../src/assets/index.js'
  ...
  return (
    ...
    <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
     <Link  href="/" className='flex items-center gap-2' onClick={()=>{
      ...
      <p className='text-white text-[18px]  font-bold cursor-pointer'>Abhishek <span> Katiyar</span></p>
     </Link>
     ...
     <div className="sm:hidden flex flex-1 justify-end items-center">
      <img src={ toggle ? close.src : menu.src} alt="menu"
